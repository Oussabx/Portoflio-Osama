(function () {
  ...
  // Content comes from content/data.js (edited with admin.html).
  var data = window.PORTFOLIO;
  if (data && data.site) { content.site = data.site; renderSite(data.site); }
  content.projects = (data && data.projects) || [];
  renderProjects();
  ...
  // Contact form: posts to the form service set in admin.html (e.g. Formspree),
